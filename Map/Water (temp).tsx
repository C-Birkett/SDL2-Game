...
<tileset version="1.5" tiledversion="1.7.0" name="Water (temp)" tilewidth="16" tileheight="16" tilecount="15" columns="5">
 <image source="Water_tileset.png" width="80" height="48"/>
 <wangsets>
  <wangset name="Water (temp)" type="corner" tile="-1">
   <wangcolor name="Water(temp)" color="#ff0000" tile="-1" probability="1"/>
